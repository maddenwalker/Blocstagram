...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *cancelButton = [[UIBarButtonItem alloc] initWithImage:cancelImage landscapeImagePhone:cancelImage style:UIBarButtonItemStyleDone target:self action:@selector(cancelButtonPressed:)];
